...
- Daily goal setting (indefinite and long-term goals)
- Writing sessions with word count tracking
- Progress tracking on homepage
- Settings customization
- Overall app stability

KNOWN ISSUES:
- App is unsigned, so Windows shows security warnings
- This is expected for beta testing

FEEDBACK:
Please report any bugs, crashes, or confusing parts of the app.
Focus on:
- Does the tutorial make sense?
- Are the goals easy to set up and understand?
